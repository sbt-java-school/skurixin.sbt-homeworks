...
//
//    @Autowired
//    private IngredientService ingredientDao;
//    @Autowired
//    private RecipeService recipeDao;
//    @Autowired
//    private RecipesToIngredientsService recipesToIngredientsDao;
//
...
//                Recipe recipe = recipeDao.addRecipe(new Recipe(name));
...
//        String name = consoleReader.readLine();
//        try {
//            ingredientDao.addIngredient(new Ingredient(name));
//        } catch (DuplicateKeyException e) {
