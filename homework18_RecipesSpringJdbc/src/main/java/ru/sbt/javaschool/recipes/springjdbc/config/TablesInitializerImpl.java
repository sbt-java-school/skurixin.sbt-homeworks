...
public class TablesInitializerImpl implements TablesInitializer {
    ...
    public static final String SCRIPT_CREATE = "RecipesSpringJdbc/src/main/resources/sql/createTables.sql";
    public static final String SCRIPT_DROP = "RecipesSpringJdbc/src/main/resources/sql/dropTables.sql";
    public static final String SCRIPT_FILL = "RecipesSpringJdbc/src/main/resources/sql/fillTable.sql";
    @Autowired
